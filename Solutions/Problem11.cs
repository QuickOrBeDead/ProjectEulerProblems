...
namespace Solutions
{
    ...
    {
        private const string NUMBERS = @"08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48";
        ...
        private static int[][] ParseNumbers()
        {
            ...
            string[] lines = NUMBERS.Split(new[] {"\n", "\r\n"}, StringSplitOptions.RemoveEmptyEntries);
            for (int i = 0; i < lines.Length; i++)
            {
                string line = lines[i];
                numbers[i] = line.Split(new[] {" "}, StringSplitOptions.RemoveEmptyEntries).Select(int.Parse).ToArray();
            }
            return numbers;
        }
    }
